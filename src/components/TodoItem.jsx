...
export default function TodoItem({ todo, onToggle, onDelete, onUpdateDueDate, onUpdateMemo, draggable: isDraggable, kanban }) {
      ...
      {kanban ? (
        <>
          <span
            ...
            className={`block cursor-pointer text-sm select-none mb-2 ${
